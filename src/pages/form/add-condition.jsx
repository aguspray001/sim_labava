...
export const AddCondition = () => {
  ...
  const [number_condition, setNumberCondition] = useState(null);

  const ConditionAdd = async (condition, number_condition) => {
      ...
      <Card>
        <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
          <Typography variant="h6" color="white">
            Form Penambahan Kondisi Inventaris Lab AVA
          </Typography>
        </CardHeader>
        <CardBody className="px-0 pt-0 pb-2">
          ...
          <div>
            <div className="flex flex-col gap-6 col-span-2 items-center">
              <Button className="my-4" color="indigo" size="lg" onClick={() => ConditionAdd(condition, number_condition)}>
                Submit
              </Button>
            </div>
          </div>
